...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between px-16 py-10 md:p-24">
      <section className="">
        <div className="flex flex-col space-y-6 lg:space-y-0 lg:grid max-w-screen-xl px-4 py-8 mx-suto  lg:gap-8 xl:gap-0 lg:py-16 lg:px-8 lg:grid-cols-12">
                  ...
                  ? products
                      ...
                      .map((productItem) => (
                        <li
                          ...
                          key={productItem._id}
                        >
                          <div className="w-full rounded aspect-square relative">
                            <Image
