...
const Checkout = () => {
  ...
  const publishableKey =
    "pk_test_51O2s4oSBkGfmYeLgkOtXoUA30EHO7NArTyNQCiCnpdSQeFMnNaqzXh293enzL8MKpu2PdNlo1vlCR22aCPaYPfHV00JUGMBiGj";
            ...
            {cartItems && cartItems.length ? (
              cartItems.map((item) => (
                <div
                  ...
                  key={item._id}
                >
                  <div className="m-2 h-24 w-28 relative rounded-md border ">
                    <Image
                      fill={true}
                      objectFit="cover"
